...
// OAuth permissions are configured via Facebook Login Configuration (config_id)
// in the Facebook App Dashboard instead of being passed as scope in the URL.
// The configuration includes these permissions:
//   pages_show_list, business_management, instagram_basic,
//   instagram_manage_comments, pages_read_engagement, public_profile
