...
import { Shield, Globe, DollarSign, Monitor, FileText } from 'lucide-react'
...
const trustReasons = [
  ...
  },
  {
    ...
    description: 'Не збираємо й не продаємо особисті дані; коментарі зберігаються максимум 24 години.',
      ...
      <Section id="benefits" background="gray">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className={`w-12 h-12 rounded-lg ${benefit.color} flex items-center justify-center mx-auto mb-4`}>
