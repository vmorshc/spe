...
import { Filter, FileText, Package, Globe } from 'lucide-react'
      ...
      >
        <div className="bg-white rounded-xl p-8 shadow-sm">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Підписуйтесь на наші оновлення, щоб отримувати повідомлення про нові 
            можливості та покращення сервісу.
          </p>
