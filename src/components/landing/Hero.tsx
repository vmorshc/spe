    ...
    <Section className="pt-8 lg:pt-16" background="white">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            Обери переможця{' '}
            <span className="text-blue-600">чесно</span> — за хвилину, без сумнівів
          </motion.h1>
          ...
          >
            Наш сервіс автоматично завантажує коментарі, обирає випадкового переможця 
            й одразу показує результат. Ніяких екселів, скріншотів і підозрілих 
            «рандомайзерів» — лише прозорий процес.
          </motion.p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8 shadow-lg">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-4 rounded-lg text-center">
                ...
                <p className="text-sm opacity-90">Коментар #423</p>
              </div>
            </div>
          </div>
        </motion.div>
