...
const faqData = [
  ...
  {
    question: 'Як оплачуються розіграші?',
    answer: 'Оплата відбувається через plata by mono після підтвердження результату. Ви платите лише тоді, коли дійсно провели розіграш.'
  },
  {
    question: 'Чи зберігаються мої дані?',
    answer: 'Ні, ми не збираємо й не продаємо особисті дані. Коментарі зберігаються максимум 24 години для проведення розіграшу, після чого автоматично видаляються.'
  },
  {
    question: 'Чи можу я перевірити справедливість результату?',
    answer: 'Так, ми використовуємо crypto-safe RNG алгоритм. Також плануємо впровадити публічний сертифікат прозорості для додаткової перевірки.'
  },
  {
    question: 'Які типи акаунтів можуть використовувати сервіс?',
    answer: 'Сервіс працює з бізнес-акаунтами та creator-акаунтами в Instagram. Особистий акаунт не дає доступу до необхідних API.'
  }
]
